        ...
        <div class="container">
          ...
          <div class="row justify-content-between">
            ...
            <div className="col-lg-6 pt-5 pt-lg-0">
              <h3 data-aos="fade-up" style={{ color: "#800000", fontFamily: "'Georgia', serif" }}>Kyon Chuniye Saanjh Nu?</h3>
              <p data-aos="fade-up" data-aos-delay="100" style={{ fontSize: "18px", color: "#555" }}>
              ...
              <div className="row">
                <div className="col-md-6" data-aos="fade-up" data-aos-delay="100">
                  <i className="bx bx-receipt" style={{ color: "#d4418e" }}></i>
                  <h4 style={{ color: "#b07d0b" }}>Khandani Verification</h4>
                ...
                <div className="col-md-6" data-aos="fade-up" data-aos-delay="200">
                  <i className="bx bx-cube-alt" style={{ color: "#d4418e" }}></i>
                  <h4 style={{ color: "#b07d0b" }}>Asli Success Stories</h4>
